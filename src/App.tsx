            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="grid flex-1 grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
                {clientLogos.items.map((item) => (
                  <div
                    key={item}
                    className="flex min-h-[84px] items-center justify-center rounded-[1.25rem] border border-[#e9d8d9] bg-[#fff7f7] px-4 text-center text-sm font-semibold uppercase tracking-[0.18em] text-[#7b1d24] shadow-sm"
                  >
                    {item}
                  </div>
                ))}
